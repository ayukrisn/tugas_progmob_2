...
Future<void> fetchTransactionTypes() async {
    try {
      ...
      if (responseData['success']) {
        setState(() {
          _transactionTypes = List<Map<String, dynamic>>.from(responseData['data']['jenistransaksi']);
        });
      }
    } catch (e) {
              ...
              child: Column(
                ...
                children: <Widget>[
                  DropdownButtonFormField<int>(
                    ...
                    validator: (value) => value == null ? 'Silakan pilih jenis transaksi' : null,
                  ),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon:
                            Icon(Icons.monetization_on_rounded, color: Color(0xFF5E5695)),
                    ),
                    validator: (value) {
